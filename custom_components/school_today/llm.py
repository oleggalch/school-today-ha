...
class SchoolTodayMenuTool(llm.Tool):
    ...
    description = (
        ...
        "что будет в школе на завтрак, второй завтрак, обед, полдник или ужин. "
        "Дата должна быть в формате YYYY-MM-DD. "
        "Приём пищи: завтрак, второй завтрак, обед, полдник или ужин."
    )
    ...
    parameters = vol.Schema({
        ...
        vol.Required(
            "meal",
            description="Приём пищи: завтрак, второй завтрак, обед, полдник или ужин.",
        ): str,
    })
    ...
    async def async_call(
        ...
        meal_map = {
            ...
            "другой завтрак": "Другий сніданок",
            "другий сніданок": "Другий сніданок",
